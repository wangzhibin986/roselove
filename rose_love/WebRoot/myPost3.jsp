    ...
    <div class="m_middle">
    	<div class="photo_top_bj">
        	<table  width="98%" height="90%" align="center"  border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="6%" align="center"  bgcolor="#FFF9E9"><a href="myPost.html"><img src="img/post1.jpg" /></a></td>
                <td class="photo_top" bgcolor="#FFF9E9" width="10%"><font style="font-weight:bold; color:#666666;"><a href="myPost.html">收件箱</a></font></td> 
                <td width="6%" bgcolor="#FFF9E9" align="center"><a href="myPost2.html"><img src="img/post2.jpg" /></a></td>
                <td width="10%"  bgcolor="#FFF9E9"><font style="font-weight:bold; color:#666666;"><a href="myPost2.html">发邮箱</a></font></td>
                <td width="2%">&nbsp;</td>
                <td width="6%" align="center"><a href="myPost3.html"><img src="img/post3.jpg" /></a></td>
                <td  width="10%"><font style="font-weight:bold; color:#666666;"><a href="myPost3.html">写&nbsp; 信</a></font></td>
                <td width="53%">&nbsp;</td>
              </tr>
            </table>
        ...
        <div class="photo_body">
        	<table width="98%" align="center" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr bgcolor="#F3F3FF">
                <td width="14%" align="center" height="25">收件人:</td>  
                <td width="86%"><input type="text" /></td>
              </tr> 
              <tr>
                <td height="5"></td>
                <td></td> 
              ...
              <tr bgcolor="#FAF9FF">
                <td width="14%" align="center" height="25">标 题:</td>  
                <td width="86%"><input type="text" /></td>
              </tr>
              <tr>
                <td height="5"></td>
              ...
              <tr>
                <td width="14%" align="center" height="25" valign="top">内 容:</td>  
              <td width="86%" valign="top">
               	<textarea cols="55" rows="20">改为编辑器</textarea>                </td>
              </tr>
              <tr>
                <td height="60" colspan="2"  align="right"><img src="img/fs.jpg" />&nbsp;&nbsp;&nbsp;&nbsp; </td>
              </tr> 
            </table> 
      </div>
        <div class="photo_top_bj">
